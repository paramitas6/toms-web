// src/app/(customerFacing)/services/page.tsx
...
export default function ServicesPage() {
  ...
  return (
    <div className="relative flex flex-col">
      ...
      {/* Main Content */}
      <div className="relative z-20 container mx-auto px-4 py-16 mt-[40vh]">
            ...
            >
              ...
              >
                ...
                <Button
                  ...
                  variant="ghost"
                  className="mt-4 flex items-center text-gray-400 hover:text-gray-700"
                >
