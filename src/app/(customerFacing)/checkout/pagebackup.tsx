          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white rounded-lg p-6 w-11/12 md:w-1/2">
              ...
              <p className="text-gray-700 mb-4">
                Please ensure the delivery address and instructions are correct. If the recipient is not home, our delivery person will leave the flowers at the front door. We are not responsible for any damage due to extreme weather conditions such as excessive heat or cold.
              </p>
              <div className="flex items-center mb-4">
                ...
                />
                <label htmlFor="waiverAccepted" className="ml-2 text-gray-700">
